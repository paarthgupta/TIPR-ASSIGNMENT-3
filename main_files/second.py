#[2;2RR[2;2RR[2;2RRR2RiR[2;2R
"""Untitled0.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1XC1OKXrS_B1gbLeYzRDECVfNk79WVeiC
"""
...
#add both the test paths        
        ...
        if arguments[4]=="Fashion-MNIST":
            ...
            #train_label=tf.one_hot(np.array(train_label),10)
            #train_label=np.array(train_label).reshape(60000,10)
...
# need to change
            ...
            #print(np.array(test_set)[0])
            #print(np.array(test_label)[0])
            #train_label=tf.one_hot(np.array(train_label),10)
            #train_label=np.array(train_label).reshape(60000,10)
...
#             with open(train_path+'/data_batch_1', 'rb') as fo:
#                 dict1 = pickle.load(fo, encoding='latin1')
#             with open(train_path+'/data_batch_2', 'rb') as fo:
#                 dict2 = pickle.load(fo, encoding='latin1')
#             with open(train_path+'/data_batch_3', 'rb') as fo:
#                 dict3 = pickle.load(fo, encoding='latin1')
#             with open(train_path+'/data_batch_4', 'rb') as fo:
#                 dict4 = pickle.load(fo, encoding='latin1')
#             with open(train_path+'/data_batch_5', 'rb') as fo:
#                 dict5 = pickle.load(fo, encoding='latin1')
# #change            
#             with open(train_path+'/data_batch_5', 'rb') as fo:
#                 dict6 = pickle.load(fo, encoding='latin1')


#             label1=np.array(dict1['labels'])
#             label2=np.array(dict2['labels'])
#             label3=np.array(dict3['labels'])
#             label4=np.array(dict4['labels'])
#             label5=np.array(dict5['labels'])
#             label6=np.array(dict6['labels'])
#             train_label=np.concatenate((label1, label2,label3,label4,label5), axis=None)
#             test_label=label6
            
#             data1=np.array(dict1['data'])
#             data2=np.array(dict2['data'])
#             data3=np.array(dict3['data'])
#             data4=np.array(dict4['data'])
#             data5=np.array(dict5['data'])
# ;            data6=np.array(dict6['data'])
